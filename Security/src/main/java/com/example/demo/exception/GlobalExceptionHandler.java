...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ErrorResponse> handleUserAlreadyExists(UserAlreadyExistsException ex) {
    ...
    public final ResponseEntity<ErrorResponse> handleInvalidCredentials(
