...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ErrorResponse> handleBookingNotFound(BookingNotFound ex) {
    ...
    public final ResponseEntity<ErrorResponse> handleBookingAlreadyCancelled(BookingAlreadyCancelled ex) {
